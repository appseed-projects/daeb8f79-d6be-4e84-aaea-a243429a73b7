...
- Timestamp: `2022-07-06 23:40`
- Build ID: `daeb8f79-d6be-4e84-aaea-a243429a73b7`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/daeb8f79-d6be-4e84-aaea-a243429a73b7.git
$ cd daeb8f79-d6be-4e84-aaea-a243429a73b7
```
